...
$lang = array_merge($lang, array(
	'TRANSLATION_INFO'	=> 'Polskie wsparcie <a href="http://phpbbsite.pl">phpBB</a> - <a href="http://phpbbsite.pl">phpBBSite.pl</a>',
	'DIRECTION'			=> 'ltr',
	'DATE_FORMAT'		=> '|j M Y|',
	'USER_LANG'			=> 'pl',
	...
	'ACCOUNT_DEACTIVATED'			=> 'Twoje konto zostało ręcznie deaktywowane i może zostać aktywowane ponownie jedynie przez administratora forum.',
	'ACCOUNT_NOT_ACTIVATED'			=> 'Twoje konto nie zostało jeszcze aktywowane.',
	'ACP'							=> 'Panel administracyjny',
	'ACTIVE'						=> 'aktywny',
	'ACTIVE_ERROR'					=> 'Określony użytkownik jest nieaktywny. Jeśli masz problemy z aktywacją swojego konta, skontaktuj się z administratorem forum.',
	...
	'ALL_TIMES'						=> 'Czasy w strefie %1$s %2$s',
	'ALL_TOPICS'					=> 'Wszystkie tematy',
	'AND'							=> 'i',
	'ARE_WATCHING_FORUM'			=> 'Zacząłeś obserwować ten dział, co oznacza, że będziesz informowany o nowo napisanych postach w nim.',
	'ARE_WATCHING_TOPIC'			=> 'Zacząłeś obserwować ten temat, co oznacza, że będziesz informowany o nowo napisanych postach w nim.',
	'ASCENDING'						=> 'Rosnąco',
	'ATTACHMENTS'					=> 'Załączniki',
	'ATTACHED_IMAGE_NOT_IMAGE'		=> 'Plik obrazka, który próbujesz załączyć jest niepoprawny.',
	'AUTHOR'						=> 'Autor',
	'AUTH_NO_PROFILE_CREATED'		=> 'Nie udało się utworzyć profilu użytkownika.',
	'AVATAR_DISALLOWED_CONTENT'		=> 'Przesyłanie zostało przerwane, ponieważ przesyłany plik został zidentyfikowany jako potencjalnie niebezpieczny.',
	'AVATAR_DISALLOWED_EXTENSION'	=> 'Ten plik nie może zostać wyświetlony, ponieważ rozszerzenie <strong>%s</strong> nie jest dozwolone.',
	...
	'AVATAR_EMPTY_FILEUPLOAD'		=> 'Wysłany plik awatara jest pusty.',
	'AVATAR_INVALID_FILENAME'		=> '%s jest niepoprawną nazwą pliku.',
	'AVATAR_NOT_UPLOADED'			=> 'Awatar nie może zostać wysłany.',
	...
	'CHANGING_PREFERENCES'	=> 'Zmień ustawienia forum',
